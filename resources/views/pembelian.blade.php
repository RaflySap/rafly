...
str_replace('/','',$p->kode_pembelian) }}">
    ...
    str_replace('/','',$p->kode_pembelian) }}">
            ...
            @if(Auth::user()->role!='Guest')
            <td>
                <button class=" btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalDeletepembelian{{ str_replace('/','',$p->kode_pembelian) }}">Delete</button>
            </td>
            @endif
        </tr>
        ...
        <div class="modal fade" id="ModalDeletepembelian{{ str_replace('/','',$p->kode_pembelian) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
